...
Before starting the lab, **OPEN THE [REFERENCE SHEET](https://github.com/Purdue-CSUSB/CS-193-S2018/blob/master/Labs/Lab3/lecture03-vim-sublime.md)**
...
```bash
wget -nc -O ~/.vimrc https://raw.githubusercontent.com/Purdue-CSUSB/CS-193-S2018/master/Labs/Lab3/vimrc
```
...
```bash
wget -N -P ~ https://raw.githubusercontent.com/Purdue-CSUSB/CS-193-S2018/master/Labs/Lab3/buggy-drjava.tar.gz
```
...
to replace all instances of "statc" to "static" in this file (Hint: you can find how do do this in the [lecture slides](https://docs.google.com/presentation/d/1RIthuttd_3qsLpLuvk87GVLikgk13MzLRMGyiYD0PZ4/edit))
...
```
https://raw.githubusercontent.com/Purdue-CSUSB/CS-193-S2018/master/Labs/Lab3/animals.txt
and
https://raw.githubusercontent.com/Purdue-CSUSB/CS-193-S2018/master/Labs/Lab3/animal-stats.rb
```
