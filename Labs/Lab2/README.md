...
Before starting the lab, **OPEN THE [REFERENCE SHEET](https://github.com/Purdue-CSUSB/CS-193-S2018/blob/master/Labs/Lab2/your_environment.md)**

### The Magic Command ###

**ONLY RUN THIS ONCE. IF YOU ALREADY HAVE A ~/bin DIRECTORY RENAME IT TO AVOID LOOSING YOUR PROGRAMS**

    cd; wget -NP ~/bin https://raw.githubusercontent.com/Purdue-CSUSB/CS-193-S2018/master/Labs/Lab2/dirinfo
